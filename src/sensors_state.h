 ...
 * -IO SWITCH:
 *            Bit7	        Bit6	      Bit5	     Bit4	     Bit3	     Bit2	       Bit1	         Bit0
 * 0x15A8     Idle-switch   AC-sw         AC-relay   RadFan      FuelPump    Purge         Pinging       Pressure-xchng
 * 
 * -ACTIVE CODE:
 *            Bit7	        Bit6	      Bit5	     Bit4	     Bit3	     Bit2	       Bit1	         Bit0
 ...
 * 0x0049	  FuelTrim(41)  Idle-sw(42)   n/a        WGC(44)     Baro(45)    WrongMAF(49)  N-switch(51)  P-switch(52)
 * 
 * -STORED CODE:
 *            Bit7	        Bit6	      Bit5	     Bit4	     Bit3	     Bit2	       Bit1	         Bit0
 ...
 * 0x1606	  FuelTrim(41)  IdleSw(42)    n/a        WGC(44)     Baro(45)    WrongMAF(49)  N-switch(51)  P-switch(52)
 *
